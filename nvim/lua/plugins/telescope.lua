return {
  ...
  config = function()
	...
	vim.keymap.set('n', '<leader>fl', require('telescope.builtin').current_buffer_fuzzy_find, { desc = 'Fuzzy find in current buffer' })
	...
	vim.keymap.set('n', '<leader>ft', require('telescope').extensions.file_browser.file_browser, { desc = 'File browser' })
