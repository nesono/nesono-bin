...
from cert_list import cert_check, print_result_table, main, limit_days
...
class TestCertCheck:
    ...
    def test_cert_check_https_expiring_soon(self, mock_retrieve: Mock) -> None:
        ...
        assert result[0] == "example.com"
        expected_msg = f"Some certificates to expire within {limit_days} days"
...
class TestMainCLI:
    def test_main_single_check(self) -> None:
        ...
        with (
            patch("cert_list.cert_check") as mock_cert_check,
    ...
    def test_main_from_file_with_empty_lines(self) -> None:
        ...
        with (
            patch("cert_list.cert_check") as mock_cert_check,
            patch("cert_list.print_result_table"),
        ):
            mock_cert_check.side_effect = [
                ["example.com", "2024-01-01", "2025-12-31", "", "color_code"],
                [
